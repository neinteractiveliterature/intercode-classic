...
echo "            <p>\n";
echo "            <li>The room block code is \"Intercon\".  Please give this code when you call the Radisson.\n<br/>\n";
echo "            <table border=\"0\" cellspacing=\"2\" cellpadding=\"2\">\n";
echo "              <tr class=\"reserveBody\">\n";
echo "                <td>&nbsp;&nbsp;&nbsp;</td>\n";
echo "                <td>Room:</td>\n";
echo "                <td>$104/night</td>\n";
echo "              </tr>\n";
echo "              <tr class=\"reserveBody\">\n";
echo "                <td>&nbsp;&nbsp;&nbsp;</td>\n";
echo "                <td>Suite:</td>\n";
echo "                <td>$124/night</td>\n";
echo "              </tr>\n";
echo "            </table>\n";
echo "	    This rate covers 2 people per room.  There will be an\n";
echo "	    additional charge of $12 for each additional person to\n";
...
echo "				</tr>\n";
echo "				<tr>\n";
echo "				    <th align=\"left\">Room block code:</th>\n";
echo "					<td><nobr>\"Intercon\"</nobr></td>\n";
echo "				</tr>\n";
/*echo "				<tr>\n";
