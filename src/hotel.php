...
echo "            <p>\n";
echo "            <li>The room block code is \"Intercon\".  Please give this code when you call the Westin.\n<br/>\n";
...
echo "              </tr>\n";
echo "            </table>\n";
echo "	    These rates covers 2 people per room.\n";
echo "	    <p>\n";
...
echo "				</tr>\n";*/
echo "				<tr>\n";
echo "				    <th align=\"left\">Hotel Fax:</th>\n";
echo "					<td><nobr>(781) 290-5626</nobr></td>\n";
echo "			    </tr>\n";
echo "				<tr>\n";
echo "				    <td colspan=\"2\" align=\"center\"><hr></td>\n";
echo "				</tr>\n";
