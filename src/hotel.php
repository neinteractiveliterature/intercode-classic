...
echo "                <td>&nbsp;&nbsp;&nbsp;</td>\n";
echo "                <td>Room:</td>\n";
echo "                <td>rates TBD</td>\n";
echo "              </tr>\n";
echo "            </table>\n";
echo "	    This rate covers 2 people per room.  Information about breakfast vouchers, if applicable,\n";
echo "      will be updated here as soon as it is available.\n";
echo "	    <p>\n";
